...
test('loads a BAM and changes the selected contig', async ({ page }) => {
  ...
  await expect(page.getByText('21–80 (1-based)')).toBeVisible()
  await page.keyboard.press('ArrowRight')
  await expect(page.getByText('33–92 (1-based)')).toBeVisible()
  await page.keyboard.press('Home')
  await expect(page.getByText('1–100 (1-based)')).toBeVisible()
